...
Our ablation study reveals that \oursD2~delivers consistent gains across all metrics, while \oursB4~fails to improve tracking accuracy and degrades perceptual quality (LPIPS), revealing that view-aware penalty alone is insufficient without a learnable weighting function.
